...
import 'package:firebase/features/auth/presentation/view_model/sign_in_controller.dart';
...
class SignIn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(SignInController(authSignIn: AuthSignIn()));
                ...
                children: <Widget>[
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () => Get.offAllNamed(signUpPath),
                        child: const Text(
                          'sign up',
